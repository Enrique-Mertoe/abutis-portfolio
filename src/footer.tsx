export default function Footer() {
    return (
        <footer className="text-light vstack py-4 bg-secondary-grad mt-6">
                ...
                <div className="row g-3 g-md-4 align-items-center">
                    <div className="col-md-6">
                        <h2 className="mb-0 lh-base">Get started on your path to
                            ...
                            <span
                                className="position-absolute top-50 start-50 translate-middle z-index-n1 ms-n2 d-none d-lg-block">
                    ...
                    <div className="col-md-5 text-md-end ms-auto">
                        <a className="btn btn-lg btn-primary-soft icon-link icon-link-hover mb-0" href="#">Start Your
                            Journey<i className="bi bi-arrow-right"></i> </a>
                    </div>
                </div>
            </div>
            <hr/>
            <div className="mx-auto mt-3 mt-md-0"> Copyrights &copy;2024 Abuti Martin. All rights reserved.
            </div>
        </footer>
    )
}