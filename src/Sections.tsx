            ...
            <div className="container">
                <div>
                    <div className="row pt-3 text-light align-items-center gy-8">
                        <div className="col-7">
                            <div>
                                <h1 className="display-3 position-relative hero-text my-3"
                                    data-text="Greetings!">Greetings!

                                    <span
                                        className="position-absolute text-warning top-50 start-50 translate-middle ms-3 z-n2">
                                ...
                                <p className="fw-bold ms-6">Full-Stack Developer & IoT Innovator <br/> <br/> <i>Turning
                                    ideas into
                                    smart solutions.</i></p>
...
const AboutSection = function () {
    return (
        <section className="py-5 text-light about-section">
            <div className="container">
                <div className="row g-4 align-items-center">
                    ...
                    <div className="col-lg-6 order-first ps-md-5">
                        ...
                        <p className="mb-0">
                            I’m a Full-Stack Developer, IoT Engineer, and Software Architect with <span
                            className="text-warning">4+ years</span> of experience
                            creating tailored solutions across web development, embedded systems, and telecom platforms.
                            Currently in my final year of Electrical and Electronics Engineering, I blend hardware
                            expertise with software innovation to develop powerful, end-to-end applications ✨.
                        </p>
                    </div>
                ...
                <div className="row position-relative zindex-2 py-5 my-1 my-md-3">
                    <div className="col-md-6">
                        <div className="mx-auto">
                            <h2 className="h1 pb-1 pb-md-3 pb-lg-4">
                                Looking to build something amazing? Let's collaborate and turn ideas into reality!
                            </h2>
                            ...
                            <a href="#" className="btn btn-lg btn-primary shadow-primary mt-3 w-100 w-sm-auto">Join now</a>
                        </div>
                    </div>
                    <div className="col-md-6 hstack">
                        <img src={el1}
                             className="z-index-1 w-75 ms-auto" alt=""/>
                    </div>
                </div>
            </div>
        </section>
